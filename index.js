...
let clientId = '97d6424b-fcb9-4a50-bba1-914d00f842aa';
let clientSecret = 'AI-TgehQKPfyXMiZ0WMpqAnClzsZ0VLwFfD85BvueAicDncx9vQcLOGLNaR4zHhnfZ0I9Dfo2z54mh0ziDSYBJw';
let client = mkfhir({
...
app.get('/token', (req, res) => {
    request.post({ 
        url: 'https://sb-auth.smarthealthit.org/token', 
        form: {}, 
